...
public class ModelFire {
	...
	public static int numberOfRuns = TotalFire.TotalFire.numberOfRuns;
	...
	public static void main(String[] args) throws Exception {
		...
		{   MELAprog5 Parser= new MELAprog5();
		    Parser.parseFromFile("/Users/ludovicaluisavissat/workspacejSSTL/Fire-modelQEST/src/ModelSensor2.mela");
