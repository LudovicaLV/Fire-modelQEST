...
public class SimulatorFire {
	...
	public static void main(String[] args) {
		...
		int totalTime = TotalFire.TotalFire.simulationTime;	
		outputFileLog = CreateModel.WriteAllModelQEST.Log();
		outputFileData = CreateModel.WriteAllModelQEST.Data();
		outputFileMeta = CreateModel.WriteAllModelQEST.Meta();
		outputFileCost = CreateModel.WriteAllModelQEST.Cost();
